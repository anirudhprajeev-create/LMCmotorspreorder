...
function VehiclesPage() {
    ...
    const filteredVehicles = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useMemo"])({
        "VehiclesPage.useMemo[filteredVehicles]": ()=>{
            let filtered = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$vehicles$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["vehicles"];
            if (type) {
                filtered = filtered.filter({
                    "VehiclesPage.useMemo[filteredVehicles]": (v)=>v.type === type
                }["VehiclesPage.useMemo[filteredVehicles]"]);
            }
            if (price) {
                const [min, max] = price.split('-').map(Number);
                filtered = filtered.filter({
                    "VehiclesPage.useMemo[filteredVehicles]": (v)=>{
                        if (max) {
...
_s(VehiclesPage, "sZL7c12LypeF4u6OmlyxFgw1+2o=", false, function() {
    return [
...
//# sourceMappingURL=_0d9388d7._.js.map