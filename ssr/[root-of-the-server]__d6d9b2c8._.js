...
const prebookSchema = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].object({
    ...
    inGameNumber: __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$zod$2f$lib$2f$index$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["z"].string().min(3, "Please enter a valid number."),
...
;
;
async function mapDocToVehicle(doc) {
    const data = doc.data();
    return {
        id: parseInt(doc.id),
        make: data.make,
...
async function fetchVehicles(filters) {
    ...
    try {
        ...
        let vehicles = (await (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$firebase$2f$firestore$2f$dist$2f$index$2e$node$2e$mjs__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["getDocs"])(q)).docs.map(mapDocToVehicle);
...
async function fetchVehicleById(id) {
    ...
    try {
        ...
        if (vehicleDoc.exists()) {
            return await mapDocToVehicle(vehicleDoc);
        } else {
            return null;
        }
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d6d9b2c8._.js.map