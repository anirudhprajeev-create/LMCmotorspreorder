...
function VehicleForm({ vehicle, onFormSubmit }) {
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            if (vehicle) {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["updateVehicle"])(vehicle.id, data);
                toast({
                    title: 'Success!',
                    description: 'Vehicle updated successfully.'
                });
            } else {
                await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["createVehicle"])(data);
                toast({
                    title: 'Success!',
...
function DeleteVehicleDialog({ vehicleId, onDeleted }) {
    ...
    const handleDelete = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteVehicle"])(vehicleId);
            toast({
                title: 'Success!',
...
function GalleryImageForm({ onFormSubmit }) {
    ...
    const handleSubmit = async (event)=>{
        ...
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["addGalleryImage"])(imageData);
            toast({
                title: 'Success!',
...
function DeleteImageDialog({ imageId, onDeleted }) {
    ...
    const handleDelete = async ()=>{
        try {
            await (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$data$2e$ts__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["deleteGalleryImage"])(imageId);
            toast({
                title: 'Success!',
...
//# sourceMappingURL=%5Broot-of-the-server%5D__d7831b17._.js.map