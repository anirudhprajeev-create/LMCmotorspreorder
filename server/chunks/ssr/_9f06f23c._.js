...
async function generateMetadata({ params }) {
    const vehicle = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$vehicles$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["vehicles"].find((v)=>v.id.toString() === params.id);
    if (!vehicle) {
        return {
...
async function generateStaticParams() {
    return __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$vehicles$2e$ts__$5b$app$2d$rsc$5d$__$28$ecmascript$29$__["vehicles"].map((vehicle)=>({
...
//# sourceMappingURL=_9f06f23c._.js.map